...
"""
=================================================================================
  QUANTUM KINSHIP VERIFICATION -- TRAIN PURE FIW ENSEMBLE
=================================================================================

Creates a 5-fold ensemble trained exclusively on FIW data for use in the meta-ensemble.

Usage:
  python scripts/training/train_fiw_ensemble.py
"""
...
def main():
    ...
    print("=" * 72)
    print("  QUANTUM KINSHIP -- TRAIN PURE FIW ENSEMBLE")
    print("=" * 72)

    # Configuration - optimized for high-performance FIW ensemble
    args = type('Args', (), {})()
    args.n_qubits = 8
    args.epochs = 150          # Increased from 100 for better convergence
    args.batch_size = 32       # Reduced from 64 for better gradient estimation
    ...
    args.augment = True
    args.label_smoothing = 0.1      # Increased from 0.05 for better generalization
    args.quantum_loss_weight = 0.2  # Reduced from 0.3 to balance with other losses
    args.physics_reg_weight = 0.15  # Increased from 0.1 for better regularization
    args.fiw_root = os.path.join(project_root, "public")
    args.seed = 42
    args.patience = 15         # Increased from 10 for better convergence
